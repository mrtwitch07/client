...
import { selectRestaurant } from '../slices/restaurantySlice';
                ...
                return (
                    <View key={key}
                     ...
                     >
                      ...
                      <Text className="flex-1 font-bold text-gray-700">{dishes.name}</Text>
                      <Text className="font-semibold text-base">${dishes.price}</Text>
                      <TouchableOpacity onPress={() => dispatch(removeFromCart({id: dishes.id}))} className="p-1 rounded-full" style={{backgroundColor: themeColors.bgColor(1)}}>
